      ...
      <SafeAreaView>
        <ImageBackground source={imagesPath.login} style={{ width: "100%", height: "100%" }} >
          <View className="mx-2 h-[100vh]">
            ...
            <Text className="text-2xl-sofia font-semibold mt-10">Log In</Text>
            ...
            <Text className="text-[#FE724C] font-bold text-center mt-5">Forgot password</Text>

            <Pressable className=" flex items-center justify-center mt-4" >
              <Text className="bg-[#FE724C] px-14 py-4 text-white text-xl-sofia font-semibold rounded-xl" onPress={()=>handle()} >Login</Text>
            </Pressable>

            <Text className="text-gray-400 my-7 text-center">Don't have a account ? <Text className="text-[#FE724C] font-bold text-base-sofia" onPress={()=>navigation.navigate("Register")} > Sign in</Text></Text>
